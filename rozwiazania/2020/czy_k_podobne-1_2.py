...
class TestujPodanePrzypadki(unittest.TestCase):
    ...
    def test_pierwszy(self):
        self.assertTrue(
            czy_k_podobne(3, [5, 7, 9], [5, 7, 9], 0)
        )

    def test_drugi(self):
        self.assertTrue(
            czy_k_podobne(5, [4, 7, 1, 4, 5], [1, 4, 5, 4, 7], 2)
        )

    def test_trzeci(self):
        self.assertFalse(
            czy_k_podobne(5, [10, 9, 12, 10, 9], [10, 10, 9, 9, 12], 3)
        )

    def test_czwarty(self):
        self.assertFalse(
            czy_k_podobne(5, [3, 6, 5, 1, 8], [5, 1, 8, 3, 6], 4)
        )
